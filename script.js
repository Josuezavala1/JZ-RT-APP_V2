        ...
        <div class="dr-reference-panel" aria-label="DR Reference">
          ...
          <div class="dr-reference-split">
            <div class="dr-reference-section">
              ...
              <p><strong class="dr-reference-label-black">Comparator Physical</strong>:<br/>±0.005 inches<br/>(Pg.3)</p>
              <p><strong class="dr-reference-label-black">Comparator Acceptance</strong>:<br/>1.03 max / 0.970 min<br/>(±3 percent)<br/>(5.3 / Pg.17)</p>
            </div>
            <div class="dr-reference-divider" aria-hidden="true"></div>
            <div class="dr-reference-section">
              <div class="dr-reference-section-title">DR Pixel Values</div>
              <p><strong class="dr-reference-label-black">14-bit</strong>:<br/><strong>15%</strong>=2458<br/><strong>90%</strong>=14746</p>
              <p><strong class="dr-reference-label-black">16-bit</strong>:<br/><strong>15%</strong>=9830<br/><strong>90%</strong>=58982</p>
              <p>(Pg.8)</p>
            </div>
          </div>
        </div>
